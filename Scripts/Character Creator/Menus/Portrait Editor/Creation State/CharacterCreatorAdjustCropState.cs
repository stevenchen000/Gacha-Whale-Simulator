    ...
    public partial class CharacterCreatorAdjustCropState : CharacterCreatorState
    {
        ...
        * *******************/
        ...
        private void ZoomAndPan()
        {
            ...
            float pinchDelta = touches.pinchDelta;
            var pinchMovement = touches.pinchMovement;
            var cam = cropper.cam;
        ...
        {
            var touches = cropper.touches;
            var touchDelta = touches.dragDistance[0];
        ...
        {
            var touchPosition = cropper.touches.touchPositions[0];
        ...
        {
            var touchPos = cropper.touches.touchPositions[0];
